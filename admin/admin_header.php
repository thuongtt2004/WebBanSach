<header class="admin-header">
    ...
    <nav class="admin-nav">
        <ul class="admin-menu">
            ...
            <li>
                <a href="admin_publishers.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'admin_publishers.php' ? 'active' : ''; ?>">
                    <i class="fas fa-building"></i> Nhà xuất bản
                </a>
            </li>
            <li>
                <a href="admin_authors.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'admin_authors.php' ? 'active' : ''; ?>">
            ...
            <li>
                <a href="admin_blog_posts.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'admin_blog_posts.php' ? 'active' : ''; ?>">
